# intero [![Build Status](https://travis-ci.com/chrisdone/intero.svg)](https://travis-ci.com/chrisdone/intero) ![Build status](https://ci.appveyor.com/api/projects/status/23bdffi0bmycxn50?svg=true)
